        ...
        def extract(categoryID):
            ...
            for Product_list in button_list:
                ...
                products_Button = Button(products_Frame, text=Product_list[1],
                                         command=lambda Product=Product_list: show_details(Product), width=22,
                                         height=2, font=("Courier", 10), bg="PeachPuff2")
        ...
        with open('files/category.csv', 'r') as category_read:
            ...
            for categories_items in data_list:
                ...
                Button(details_Frame, text=categories_items[1],
                       command=lambda category=categories_items[0]: extract(category), width=22,
                       height=2, font=("Courier", 10), bg="NavajoWhite4").place(x=10, y=yAxis)
                yAxis += round(620 / 9)
...
class Payment(Frame):
    ...
    def __init__(self, master):
        ...
        def CARD():
            ...
            Entry(Payment_Details, width=40, bg="PeachPuff2").place(x=220, y=50, height=25)
            ...
            Entry(Payment_Details, width=40, bg="PeachPuff2").place(x=220, y=129, height=25)

            Label(Payment_Details, text="CVV ", font=("Courier", 25), foreground="DarkGoldenrod4",
                  bg="PeachPuff2").place(x=70, y=208, height=25)
            Entry(Payment_Details, width=40, bg="PeachPuff2").place(x=220, y=208, height=25)
            ...
            Entry(Payment_Details, width=40, bg="PeachPuff2").place(x=220, y=287, height=25)
